...
public:
	...
	//Change to set_colour function to handle the colour parameters in order
	//RGBA  and then store as ABGR
	//Default colour is set to opaque white
	inline void set_colourRGBA(int red = 255, int green = 255, int blue = 255, int alpha = 255) { UInt32 colour = (alpha << 24) | (blue << 16) | (green << 8) | red; colour_ = colour; }
